...
import com.purpuligo.ajeevikafarmfresh.Presenter.CheckoutAddressListPresenter;
import com.purpuligo.ajeevikafarmfresh.View.CheckoutAddressListView;
...
public class CheckoutAddressListInteractorImpl implements CheckoutAddressListPresenter {

    private String TAG = "CheckoutAddressListInteractorImpl";
    private CheckoutAddressListView checkoutAddressListView;
    private ArrayList<AddressDetails> addressList;
    private String notAvailable = "";

    public CheckoutAddressListInteractorImpl(CheckoutAddressListView checkoutAddressListView) {
        this.checkoutAddressListView = checkoutAddressListView;
    ...
    public void fetchAddressListFromServer(String customer_email) {
        ...
        checkoutAddressListView.showProgressBar();
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST, JSON_URL,postData,
            ...
            public void onErrorResponse(VolleyError error) {
                checkoutAddressListView.hideProgressBar();
                checkoutAddressListView.showServerError();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue((Context) this.checkoutAddressListView);
    ...
    private void fetchAddressListFromJson(JSONObject response) throws JSONException {
        ...
        if (parentObject.has(Constants.PAYMENT_OPTION.KEY_SHIPPING_ADDRESS) && !parentObject.isNull(Constants.PAYMENT_OPTION.KEY_SHIPPING_ADDRESS) &&
            ...
            checkoutAddressListView.showAddressList(addressList);
            checkoutAddressListView.hideProgressBar();
        }else {
            checkoutAddressListView.hideProgressBar();
            checkoutAddressListView.showAddressListError();}
    }
}
